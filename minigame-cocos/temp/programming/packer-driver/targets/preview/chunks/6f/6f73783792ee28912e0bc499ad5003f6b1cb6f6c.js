System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  function runProgressServiceSpec() {
    var storage = new (_crd && MemoryStorageAdapter === void 0 ? (_reportPossibleCrUseOfMemoryStorageAdapter({
      error: Error()
    }), MemoryStorageAdapter) : MemoryStorageAdapter)();
    var svc = new (_crd && ProgressService === void 0 ? (_reportPossibleCrUseOfProgressService({
      error: Error()
    ...
    var atlas = svc.getAtlasProgress();
