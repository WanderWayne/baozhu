  ...
  return {
    ...
    execute: function () {
      ...
      _export("BootScene", BootScene = (_dec = ccclass('BootScene'), _dec(_class = class BootScene extends Component {
        start() {
          const configRepo = (_crd && ConfigLoader === void 0 ? (_reportPossibleCrUseOfConfigLoader({
            error: Error()
          }), ConfigLoader) : ConfigLoader).loadFromObject(_crd && gameConfig === void 0 ? (_reportPossibleCrUseOfgameConfig({
            error: Error()
          }), gameConfig) : gameConfig);
          const storage = typeof wx !== 'undefined' ? new (_crd && WechatStorageAdapter === void 0 ? (_reportPossibleCrUseOfWechatStorageAdapter({
            error: Error()
          ...
          const progress = new (_crd && ProgressService === void 0 ? (_reportPossibleCrUseOfProgressService({
            error: Error()
          }), ProgressService) : ProgressService)(storage, configRepo.getAtlasCountableSlotIds());
          const recipes = new (_crd && RecipeEngine === void 0 ? (_reportPossibleCrUseOfRecipeEngine({
            error: Error()
          }), RecipeEngine) : RecipeEngine)(configRepo.getRecipes());
          const tasks = new (_crd && TaskService === void 0 ? (_reportPossibleCrUseOfTaskService({
            error: Error()
          }), TaskService) : TaskService)(configRepo.getTasks());
          const router = new (_crd && SceneRouter === void 0 ? (_reportPossibleCrUseOfSceneRouter({
            error: Error()
          }), SceneRouter) : SceneRouter)();
          const audio = new (_crd && AudioService === void 0 ? (_reportPossibleCrUseOfAudioService({
            error: Error()
          ...
          const wechat = new (_crd && WechatAdapter === void 0 ? (_reportPossibleCrUseOfWechatAdapter({
            error: Error()
